...
export default class Botinfo extends Command {
    ...
    async run(client, ctx) {
        ...
        let embed = this.client
            ...
            .setDescription(`Hey **${ctx.author.tag}**, I'm Nirvana, a quality music bot which makes you feel the Music and it's Beats
      
  I was built using the popular [discord.js](https://discord.js.org/) library & now I'm currently running on **${process.platform} platform** with **Discord.js V${discordjsversion}**, providing you a latency of **${Math.round(ctx.client.ws.ping)}ms**
...
//# sourceMappingURL=Botinfo.command.js.map